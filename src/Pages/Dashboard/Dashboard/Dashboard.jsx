    ...
    <div className="drawer drawer-mobile">
      ...
      <div className="drawer-content p-3 md:p-3">
        <div className="header z-50 sticky top-0 flex justify-between items-center bg-base-300 p-4 rounded">
          ...
          <div className="lg:mr-[-79rem] pt-2 md:mr-[-17rem] flex justify-center items-center mr-[-1rem]">
          ...
          <div className="dropdown dropdown-end">
            ...
            >
              <li className="py-2 ml-4 font-semibold">
                Hey, {auth?.currentUser?.displayName.slice(0, 12)}
              </li>
              <li className="py-2">
